...
import { getUserPublications, uploadPublications } from "../../actions/publicationsAction";
...
const Account = () => {
  ...
  useEffect(() => {
    ...
    // console.log(file)
  }, [error, currentPage,ob.error,ob.success]);
      ...
      <div className="profile">
        ...
        <div className="section-5">
          ...
          <div className="pb-filter">
            ...
            <div>
              <button onClick={downloadAsWorkbook} className="download-excel" title="download all publications as excel">
                Download 
              </button>
              <button className="upload-pub" onClick={handleOpen} title="upload publications">
                Upload 
              </button>
              <Modal
                open={open}
              ...
              >
                ...
                <MdOutlineClose className="close-modal" onClick={handleClose}/>
                  <div className="dcsv">
                    <p>
                      <b>Note:</b>
                  ...
                  <div>
                    <input type="file" name="Upload" onChange={(event)=>setFile(event.target.files[0])}/>
          ...
          <div className="line" style={{ width: "95%", marginTop: "0" }}></div>
          <div>
            {publications != 0 ? (
